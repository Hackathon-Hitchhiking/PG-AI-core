class PresentationAgent:
    ...
    def __init__(self, text_agent, image_agent, config):
        """Инициализация с необходимыми агентами и конфигурацией."""
        pass
    
    def create_presentation(self, user_prompt, document_path=None, template_path=None):
    ...
    def generate_slide_content(self, slide_plan, template_structure):
