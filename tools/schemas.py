...
class Coordinates(BaseModel):
    ...
    x: Optional[float] = Field(None, description="Horizontal position in inches")
    y: Optional[float] = Field(None, description="Vertical position in inches")
...
class Background(BaseModel):
    ...
    value: Optional[str] = Field(None, description="HEX color code, image path, or pattern name")
...
class ImageShape(BaseModel):
    ...
    coordinates: Coordinates
    crop: Optional[Coordinates] = Field(None, description="Crop area coordinates if any")
...
class GeometricShape(BaseModel):
    ...
    coordinates: Coordinates
    fill: Optional[str] = Field(None, description="Fill color in HEX or None if no fill")
    outline: Optional[str] = Field(None, description="Outline color in HEX or None if no outline")
...
class PresentationMeta(BaseModel):
    ...
    template: Optional[str] = Field(None, description="Template name if any")
